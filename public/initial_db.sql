...
ALTER TABLE `ai_templates` ADD `paramType_drop_down_values` TEXT NOT NULL AFTER `prompt_fields`;
...
ALTER TABLE `affiliate_withdrawal_methods`
  ADD CONSTRAINT `affiliate_withdrawal_methods_aff_id` FOREIGN KEY (`user_id`) REFERENCES `usage_logs` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
