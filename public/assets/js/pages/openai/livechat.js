"use strict";
  ...
  $(document).ready(function() {
    ...
    $.ajax({
        ...
        type:'POST',
        data:{from_user_id:from_user_id,send_message:send_message,conversation_id:conversation_id,system_prompt_value:system_prompt_value,system_prompt_model:system_prompt_model},
  ...
  $(document).on('click','#modal_send_btn',function(e){
    ...
    // Attach a click event handler to the chat box items
    $('#contacts').on('click', '#side_chat_content', function() {
