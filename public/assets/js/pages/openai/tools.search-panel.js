    ...
    $(document).on('click', '#generate', function(event) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                else Swal.fire({icon: 'error',title: global_lang_error,html: 'Something Went Wrong Please Try Again After Sometime'});
            ...
            error: function (xhr, statusText) {
                ...
                Swal.fire({icon: 'error',title: global_lang_error,html: 'Something Went Wrong Please Try Again After Sometime'});
                return false;
            }
        });
