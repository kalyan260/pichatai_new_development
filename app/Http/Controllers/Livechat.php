...
class Livechat extends Home
{
    ...
    public function load_livechat()
    {
        ...
        $data['info'] =DB::table('conversation_list')->where('user_id',$this->user_id)->orderByDesc('id')->limit(20)->get();        
    ...
    {       
        ...
        $system_prompt_value = request()->system_prompt_value;
        $system_prompt_model = request()->system_prompt_model;
