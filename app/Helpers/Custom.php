...
if ( ! function_exists('set_agency_config')){
    function set_agency_config()
    {
        ...
        $admin_user_data = DB::table('users')->select('settings.*','user_type')->leftJoin('settings','settings.user_id','=','users.id')
        ...
        return ['app_name'=>$app_name,'app_logo'=>$app_logo,'app_logo_alt'=>$app_logo_alt,'app_favicon'=>$app_favicon,'email_settings'=>$email_settings,'$thirdpary_api_settings'=>$thirdpary_api_settings];
    }
}
