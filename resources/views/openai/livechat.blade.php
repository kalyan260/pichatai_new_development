    ...
    <div class="content">
        ...
        <div class="messages" id="conversation_body">
            ...
            <div class="jumbotron p-4 text-center" id="custom_staating_msg">
                ...
                <p class="lead">{{__('Custom prompt to train personalized AI')}}</p>
                <p class="lead"><blockquote>"{{$system_prompt_config->system_prompt ?? $system_prompt_info}}"</blockquote></p>
                <div class="row mt-5">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <input type="hidden" id="system_prompt_value" name="system_prompt_value" value="You are a helpful assistant.">
                ...
                @php $model_name= get_openai_endpoint_list(); @endphp
                <label class="col-form-label"><?php echo __('Prompt Model'); ?></label>
                <?php  echo Form::select('model',$model_name['Chat']['chat/completions']['models'],'',['class'=>'form-control form-control-lg','id'=>'prompt-model' ]);?>
