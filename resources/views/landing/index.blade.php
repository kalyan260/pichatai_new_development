        ...
        @foreach($ai_sidebar_group_by_id as $menu_group_id=>$menu_items)
          ...
          @foreach($menu_items as $menu_item)
              ...
              <div class="w-full px-4 md:w-1/2 lg:w-1/3 cs-icon-lg-container">
                <div class="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".2s" style="cursor: pointer;">
                  <div class="mx-auto mb-6 flex h-[70px] w-[70px] items-center justify-center rounded-full bg-primary bg-opacity-5 text-primary transition group-hover:bg-primary group-hover:bg-opacity-100 group-hover:text-white dark:bg-white dark:bg-opacity-5 dark:text-white dark:group-hover:bg-primary dark:group-hover:bg-opacity-100 md:mb-9 md:h-[90px] md:w-[90px]">
                    <i class="{{$menu_item['template_thumb']}} cs-icon-lg" style="cursor: pointer;"></i>
                  </div>
                  <div>
                    ...
                    <p class="text-base text-dark-text"> {{__($about_text)}} {{__($menu_item['template_description'])}}</p>
                  </div>
                </div>
              </div>
          @endforeach
          ...
          <div class="-mx-4 flex flex-wrap items-center">
            ...
            <div class="w-full px-3 lg:w-1/3">
              <div class="mx-auto mb-12 max-w-[530px] text-center lg:ml-1 lg:mb-0 lg:text-left">
                <h1 class="cs-use-case-heading wow fadeInUp mb-5 font-heading text-2xl font-semibold dark:text-white sm:text-4xl md:text-[500px] md:leading-[60px]" data-wow-delay=".3s"> {{$use_case['title']}}</h1>
                <p class="wow fadeInUp mb-12 text-base text-dark-text" data-wow-delay=".4s"> {{$use_case['description']}}</p>
              </div>
            </div>
            @endforeach
          </div>
