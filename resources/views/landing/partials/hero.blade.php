    ...
    <div class="-mx-4 flex flex-wrap items-center">
      <div class="w-full px-3 lg:w-1/2">
        <div class="mx-auto mb-12 max-w-[530px] text-center lg:ml-1 lg:mb-0 lg:text-left">
          <span class="wow fadeInUp mb-8 inline-block rounded-full bg-primary bg-opacity-5 py-[10px] px-5 font-heading text-base text-primary dark:bg-white dark:bg-opacity-10 dark:text-white" data-wow-delay=".2s">
          ...
          <h1 class="wow
            ...
            <span class="txt-type" style="color: #E812E8;" data-wait="3000" data-words='<?php echo $typingKeywords?>'></span>
          </h1>
          <p class="wow fadeInUp mb-12 text-base text-dark-text" data-wow-delay=".4s"> {{__("Introducing PiChatAI powerful AI tool designed to revolutionize content creation. With its advanced capabilities, PiChatAI empowers users to effortlessly generate high-quality content across multiple mediums, including image generation, text-to-speech conversion, video transcription and many more.")}}</p>
          <div class="wow fadeInUp flex flex-wrap items-center justify-center lg:justify-start" data-wow-delay=".5s">
            <a href="{{route('register')}}" class="inline-flex items-center rounded bg-primary py-[10px] px-6 font-heading text-base text-white hover:bg-opacity-90 md:py-[14px] md:px-8" style="    font-size: 1.8rem !important;">{{__("Let's Start")}} <span class="pl-3">
          ...
          {{-- <div class="wow fadeInUp flex flex-wrap items-center justify-center lg:justify-start" data-wow-delay=".5s" style="margin-top: 20px;">
            <div class="add-to">
              <button class="add-to-btn inline-flex items-center rounded bg-primary py-[10px] px-6 font-heading text-base text-white hover:bg-opacity-90 md:py-[14px] md:px-8">Add to home screen</button>
            </div>
          </div> --}}
        </div>
      </div>
