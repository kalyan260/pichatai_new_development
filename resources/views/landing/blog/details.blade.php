...
<p>&nbsp;</p>
    ...
    <section id="pricing" class="pt-14 sm:pt-20 lg:pt-[130px]">
        <div class="px-4 xl:container">
            <!-- Section Title -->
            <div class="wow fadeInUp relative w-full pt-10 text-center lg:pt-16" data-wow-delay=".2s"> <span
                    class="title whitespace-nowrap"> {{ $item->name }} Details</span>
