<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
  ...
  <div class="navbar-menu-wrapper d-flex align-items-top  <?php if(in_array($route_name,$full_width_page_routes)) echo ' ps-5 ';?>" style="padding-top: 17px;">
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
          ...
          @if(check_build_version()=='double' && !$is_manager)
            @if(has_module_access($module_id_affiliate_system,$user_module_ids,$is_admin) && !$is_admin)
