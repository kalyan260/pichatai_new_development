            ...
            <div class="row">
                ...
                @endif --}}
                    <div class="col-12 col-md-4 pt-3">
                        <form action="{{ route('payment-razorpay-success') }}" method="POST">
                            @csrf
                            <input type="hidden" name="package_id" value="{{ $buy_package_package_id }}">
                            <input type="hidden" name="parent_user_id" value="{{ $parent_user_id }}">
                            @php
                                $final_price = $package_data->other_price * 100;
                                $final_currency = 'USD';
                                if ($location != false && $location->countryName == 'India'){
                                    $final_price = $package_data->price * 100;
                                    $final_currency = 'INR';    
                                }
                            @endphp
                            <script src="https://checkout.razorpay.com/v1/checkout.js" 
                                data-key="{{ $razorpay_data->razorpay_key_id }}" 
                                data-amount="{{ $final_price }}"
                                data-currency="{{ $final_currency }}"
                                data-buttontext="Pay" 
                                data-name="{{ config('app.name') }}" 
                                data-description="Rozerpay Payment For {{ config('app.name') }}"
                                data-image="{{config('app.ai_chat_icon')}}"
                        ...
                        <a href="#" class="list-group-item list-group-item-action flex-column align-items-start"
                            id="razorpay_clone" onclick="document.querySelector('.razorpay-payment-button').click();">
                            <div class="d-flex w-100 align-items-center">
                                <small class="text-muted"><img class="rounded" width="60" height="60"
                                        src="https://pichatai.com/assets/images/razorpay.png"></small>
                                <h5 class="mb-1">Pay with Razorpay</h5>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('paid-currency', $currency_list, $currency, [
                                    'id' => 'paid-currency',
                            ...
                            <div class="form-group">
                                ...
                                <div id="manual-payment-dropzone" class="dropzone mb-1">
                                    <div class="dz-default dz-message">
                                        <input class="form-control form-control-lg" name="uploaded-file" id="uploaded-file"
                                            type="hidden">
                ...
                <div class="modal-footer bg-whitesmoke br d-block">
                    <button type="button" id="manual-payment-submit" class="btn btn-primary m-0"><i
                            class="fas fa-save"></i> <?php echo __('Submit'); ?></button>
