                                        ...
                                        <div class="tab-pane fade active show" id="paypal-block" role="tabpanel" aria-labelledby="">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="">{{ __("Paypal App Id") }} &nbsp;&nbsp; 
                                                        <a href="https://youtu.be/T0MQ2cKQFck" target="_blank" class="text-decoration-none" rel="noopener noreferrer"><i class="fas fa-info-circle"></i> {{__("How to?")}}</a></label>
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                            <input name="paypal_app_id" value="{{old('paypal_app_id',$paypal_app_id)}}"  class="form-control form-control-lg" type="text">
                                                        </div>
                                                        @if ($errors->has('paypal_app_id'))
                                                            <span class="text-danger"> {{ $errors->first('paypal_app_id') }} </span>
                                                        @endif
                                                    </div>
                                                </div>
