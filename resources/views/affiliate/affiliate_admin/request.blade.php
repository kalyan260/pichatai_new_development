                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="input-group mb-3">
                                                             <span class="input-group-text" data-bs-toggle="tooltip" data-bs-placement="right" title=""><i class="fab fa-facebook"></i></span>
                                                            <input type="text" id="fb_link" class="form-control form-control-lg" name="fb_link" placeholder="Your Facebook Profile Link"@if (!empty($request_status->fb_link))
                                                            value= " {{ $request_status->fb_link }}"
                                                             @else
                                                                value = "{{ old('fb_link') }}"
                                                            @endif>
                                                            <div class="form-control form-control-lg-icon">
