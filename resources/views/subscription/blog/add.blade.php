<?php
    ...
    $title_display = __('Create Blog');
    $title_display_des = __('Create a Blog');
...
@section('content')
    <div class="content-wrapper">
        <form class="form form-vertical" enctype="multipart/form-data" method="POST" action="{{ route('blog.add') }}">
            @csrf
            <div class="row">
                <div class='col-12 col-md-12'>
                    <div class="card card-rounded mb-4 p-lg-2">
                        <div class="card-body card-rounded">
                            <h4 class="card-title card-title-dash mb-4">{{ __('Create A Blog') }}</h4>
                            <div class="row">
                                <div class="col-6">
