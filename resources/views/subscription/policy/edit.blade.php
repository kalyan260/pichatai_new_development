<?php
    ...
    $title_display = __('Update Policy');
    $title_display_des = __('Update Policy');
...
@section('content')
    <div class="content-wrapper">
        <form class="form form-vertical" enctype="multipart/form-data" method="POST" action="{{ route('policy.edit',$item->id) }}">
            @csrf
            <div class="row">
                <div class='col-12 col-md-12'>
                    <div class="card card-rounded mb-4 p-lg-2">
                        <div class="card-body card-rounded">
                            <h4 class="card-title card-title-dash mb-4">{{ __('Update A Policy') }}</h4>
                            <div class="row">
                                <div class="col-6">
