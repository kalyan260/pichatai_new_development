<?php
    ...
    $title_display = __('Update faq');
    $title_display_des = __('Update faq');
...
@section('content')
    <div class="content-wrapper">
        <form class="form form-vertical" enctype="multipart/form-data" method="POST" action="{{ route('faq.edit',$item->id) }}">
            @csrf
            <div class="row">
