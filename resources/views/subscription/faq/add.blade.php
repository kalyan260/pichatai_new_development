<?php
    ...
    $title_display = __('Create Faq');
    $title_display_des = __('Create a Faq');
...
@section('content')
    <div class="content-wrapper">
        <form class="form form-vertical" enctype="multipart/form-data" method="POST" action="{{ route('faq.add') }}">
            @csrf
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="name">Qextion*</label>
                                        <input name="question" class="form-control form-control-lg form-control form-control-lg-lg" type="text" value="{{ old('name') }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="name">Answar*</label>
                                        <input name="answar" class="form-control form-control-lg form-control form-control-lg-lg" type="text" value="{{ old('name') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
