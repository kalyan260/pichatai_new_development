            ...
            <div class="card-body card-rounded">
                <div class="d-sm-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <p class="card-subtitle card-subtitle-dash mb-2 mb-lg-4">{{ __('Manage faq') }}</p>
                    </div>
                    <div class="btn-wrapper mb-2">
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown d-inline">
                            <div class="btn-group" role="group">
                                <a href="{{ route('faq.add') }}" type="button" class="btn btn-otline-dark btn-sm makeDefault">
                                     {{ __('Create') }}
                                </a>
                            </div>
                        </div>
                    ...
                    <table class='table table-sm table-select' id="mytable">
                        <thead>
                            <tr class="table-light">
                                ...
                                <th class=" text-center">{{ __('Answar') }}</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($items as $item)
                                ...
                                <tr>
                                    ...
                                    <td class=" text-center">{{ $item->answar }}</td>
                                    <td class=" text-center">
                                        <a class="btn btn-info btn-sm" href="{{ route('faq.edit',$item->id) }}">
                                            <i class="fas fa-pencil-alt">
                                            </i>
                                            Edit
                                        </a>
                                        <a onclick="onClickDelete(event)" class="btn btn-danger btn-sm" href="{{ route('faq.delete',$item->id) }}">
                                            <i class="fas fa-user">
                                            </i>
                                            Delete
                                        </a>
