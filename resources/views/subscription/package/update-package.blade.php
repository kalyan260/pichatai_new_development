                    ...
                    <div class="card card-rounded mb-4 p-lg-2">
                        <div class="card-body card-rounded">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="">{{__('Other Country Price  (Price * Other Price)')}} *</label>
                                        <div class="input-group">
                                            <input type="text" step="any" value="{{ $xdata->other_price }}" name="other_price" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                @if ($xdata->id == 1)
                                    <div class="col-12 col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-text pt-4 w-100">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" id="is_default" name="is_default" type="checkbox" value="0" <?php echo (old('is_default',$xdata->is_default)=='0') ? '' : 'checked'; ?>>
                                                    <label class="form-check-label" for="is_default">{{__("Default")}}</label>
                                                </div>
                                            </span>
                                        </div>
                                        @if ($errors->has('visible'))
...
<script src="{{asset('backend/multiselect-dropdown.js') }}" ></script>
@endsection
