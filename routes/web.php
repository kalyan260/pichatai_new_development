...
if(!file_exists(public_path("install.txt"))) {
	...
	Route::get('/dashboard', [Dashboard::class,'index'])->middleware(['auth','IsPhoneVerify'])->name('dashboard');
}
else {
	Route::get('/', [Landing::class,'install'])->name('home');
	Route::get('/dashboard', [Landing::class,'install'])->middleware(['auth','IsPhoneVerify'])->name('dashboard');
}


Route::get('/dashboard/user', [Dashboard::class,'index'])->middleware(['auth','IsPhoneVerify'])->name('dashboard-user');
Route::get('/unauthorized', [Dashboard::class,'unauthorized'])->name('unauthorized');
Route::get('/unauthorized-login', [Dashboard::class,'unauthorized_login'])->name('unauthorized-login');

Route::get('settings/account',[Member::class,'account'])->middleware(['auth','IsPhoneVerify'])->name('account');
Route::post('settings/account',[Member::class,'account_action'])->middleware(['auth','XssSanitizer'])->name('account-action');
Route::get('settings',[Member::class,'general_settings'])->middleware(['auth','IsPhoneVerify'])->name('general-settings');
...
Route::get('settings/payment',[Member::class,'payment_settings'])->middleware(['auth','IsPhoneVerify'])->name('payment-settings');
...
Route::get('usage-log',[Member::class,'usage_log'])->middleware(['auth','IsPhoneVerify'])->name('usage-log');
Route::post('notification/mark-seen',[Member::class,'notification_mark_seen'])->middleware(['auth'])->name('notification-mark-seen');

Route::get('payment/transaction-log',[Member::class,'transaction_log'])->middleware(['auth','IsPhoneVerify'])->name('transaction-log');
...
Route::get('payment/transaction-log/manual',[Member::class,'manual_transaction_log'])->middleware(['auth','IsPhoneVerify'])->name('transaction-log-manual');
...
Route::get('payment/select-package',[Member::class,'select_package'])->middleware(['auth','IsPhoneVerify'])->name('select-package');
Route::get('payment/buy-package/{id}',[Member::class,'buy_package'])->middleware(['auth','IsPhoneVerify'])->name('buy-package');
...
Route::get('package/list',[Subscription::class,'list_package'])->middleware(['auth','IsPhoneVerify'])->name('list-package');
Route::post('package/list',[Subscription::class,'list_package_data'])->middleware(['auth'])->name('list-package-data');
Route::get('package/create',[Subscription::class,'create_package'])->middleware(['auth','IsPhoneVerify'])->name('create-package');
Route::post('package/create',[Subscription::class,'save_package'])->middleware(['auth','XssSanitizer'])->name('create-package-action');
Route::get('package/update/{id}',[Subscription::class,'update_package'])->middleware(['auth','IsPhoneVerify'])->name('update-package');
...
Route::get('user/list',[Subscription::class,'list_user'])->middleware(['auth','IsPhoneVerify'])->name('list-user');
Route::post('user/list',[Subscription::class,'list_user_data'])->middleware(['auth'])->name('list-user-data');
Route::get('user/create',[Subscription::class,'create_user'])->middleware(['auth','IsPhoneVerify'])->name('create-user');
...
Route::get('user/update/{id}',[Subscription::class,'update_user'])->middleware(['auth','IsPhoneVerify'])->name('update-user');
...
Route::get('credential/check', [Home::class,'credential_check'])->middleware(['auth','IsPhoneVerify'])->name('credential-check');
Route::post('credential/check', [Home::class,'credential_check_action'])->middleware(['auth'])->name('credential-check-action');
Route::get('check/update', [UpdateSystem::class,'update_list'])->middleware(['auth','IsPhoneVerify'])->name('update-list');
Route::post('initiate/update', [UpdateSystem::class,'initialize_update'])->middleware(['auth'])->name('update-initiate');



Route::get('livechat',[Livechat::class,'load_livechat'])->middleware(['auth','IsPhoneVerify'])->name('livechat.load');
...
Route::prefix('blog')->name('blog.')->group(function () {
	Route::get('/list', [BlogController::class, 'index'])->name('view');
...
Route::prefix('faq')->name('faq.')->group(function () {
	Route::get('/list', [FaqController::class, 'index'])->name('view');
	Route::get('/add', [FaqController::class, 'add'])->name('add');
	Route::post('/add', [FaqController::class, 'save']);
...
Route::prefix('policy')->name('policy.')->group(function () {
	Route::get('/list', [PolicyController::class, 'index'])->name('view');
	Route::get('/add', [PolicyController::class, 'add'])->name('add');
	Route::post('/add', [PolicyController::class, 'save']);
	Route::get('/edit/{id}', [PolicyController::class, 'edit'])->name('edit');
	Route::post('/edit/{id}', [PolicyController::class, 'update']);
	Route::get('/delete/{id}', [PolicyController::class, 'delete'])->name('delete');
});
...
require __DIR__.'/stablediffusion-api.php';
